...
// resolveBuildSessionIdentity prefers explicit session signals, then falls back
// to stable system/first-user anchors. It never invents a per-request identity.
